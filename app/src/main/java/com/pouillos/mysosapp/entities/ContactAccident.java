...
import com.pouillos.mysosapp.dao.ContactAccidentDao;

@Entity
public class ContactAccident {
    ...
    @Generated(hash = 580539063)
    private transient ContactAccidentDao myDao;

    @Generated(hash = 756016150)
    public ContactAccident(Long id, long contactId) {
        this.id = id;
        this.contactId = contactId;
    }

    @Generated(hash = 75219022)
    public ContactAccident() {
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 774554427)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getContactAccidentDao() : null;
    }
